...
import am.panov.clock.SettableClock;
...
public class LastHourStatisticsTests {
    ...
    SettableClock clock;
    EventsStatistic statistics;

    @Before
    public void before() {
        clock = new SettableClock(TIME_START);
        statistics = new LastHourEventsStatistic(clock);
    }
    ...
    public void emptyStatisticsTest() {
        final List<Long> l = statistics.getEventStatisticsByName("event");
    ...
    public void singleNameTest() {
        ...
        List<Long> l = statistics.getEventStatisticsByName("event");
